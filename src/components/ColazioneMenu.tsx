...
const cornettiItems: MenuItemData[] = [
    ...
    { name: 'Cornetto Crema e Amarena', description: 'Un classico intramontabile: crema pasticcera e amarene.', price: '1.50', icons: '🌾🥚🥛' },
    ...
    { name: 'Cornetto Confettura di Albicocche', description: 'Con confettura extra di albicocche Pellecchiella del Vesuvio.', price: '1.50', icons: '🌾🥚🥛' },
