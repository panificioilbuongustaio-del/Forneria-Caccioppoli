...
const frittiItems: MenuItemData[] = [
  ...
  { name: 'Frittatina di Pasta e Patate', description: 'Spaghetti di grano Senatore Cappelli con patate, besciamella, pancetta arruscata e provola affumicata.', price: '2.50', icons: '🥔🥓' },
  { name: 'Polpetta della Nonna', description: 'La ricetta classica napoletana: macinato di scottona, pane raffermo, provola e pecorino dei Monti Lattari, uova e prezzemolo. Fritte come una volta.', price: '2.00', icons: '🥩🍞' },
  { name: 'Crocchè Napoletano', description: 'Il vero crocchè della tradizione: patate fresche, prezzemolo e un cuore filante di fiordilatte.', price: '1.80', icons: '🥔🧀' },
];
