...
const pranzoItems: MenuItemData[] = [
    ...
    { name: 'Tegliuccio Patate e Würstel Artigianali', description: 'Patate fritte a stick, würstel artigianale "Cillo" di Marchigiana, provola liquida, fiordilatte del Caseificio Aurora, olio EVO.', price: '8.00', icons: [] },
    ...
    { name: 'Tegliuccio Diavolo Giallo', description: 'Ristretto di datterino giallo biologico, datterino giallo confit, mozzarella del Caseificio Aurora, filetti di salame a punta di coltello "Cillo", basilico, olio EVO monocultivar Rotondella.', price: '8.00', icons: [] },
