...
const tegliucciItems: MenuItemData[] = [
  { name: 'Tegliuccio Allardiato', description: "Pomodoro datterino biologico, lardo di maiale nero, pecorino dei Monti Lattari grattugiato, profumo di alloro, pepe intero biologico macinato al momento.", price: '8.00', icons: '🌾🥛🐖' },
  { name: 'Tegliuccio "A Cas e Mammà"', description: "Ragù di pomodoro San Marzano biologico, braciola di manzo con capperi 'lacrimella' del Vesuvio, prezzemolo e pecorino dei Monti Lattari, profumo di basilico.", price: '8.00', icons: '🌾🥛🥩' },
  ...
  { name: 'Tegliuccio Diavolo Giallo', description: 'Ristretto di datterino giallo biologico, datterino giallo confit, mozzarella del Caseificio Aurora, filetti di salame a punta di coltello "Cillo" di suino casertano, olio EVO al peperoncino.', price: '8.00', icons: '🌾🥛🐖' },
  { name: 'Tegliuccio Broccoli e Salsiccia', description: "Crema di broccolo 'Friariello' di Sant'Antonio Abate, salsiccia di maiale nero, provola dei Monti Lattari, basilico, olio EVO.", price: '8.00', icons: '🌾🥛🐖' },
  { name: 'Tegliuccio Orto di Inverno', description: "Zucca, Cardoncelli, Porcini freschi, Provola di Agerola, aglio, olio, peperoncino", price: '8.00', icons: '🌾🥛', seasonalNote: 'Disponibile solo in inverno' },
  { name: 'Tegliuccio Essenza di Pomodoro e Mozzarella', description: "Ristretto di datterino biologico, battuto di olio EVO monocultivar Rotondella con aglio, prezzemolo e peperoncino, filetti di mozzarella di bufala, basilico.", price: '8.00', icons: '🌾🥛' },
  { name: 'Tegliuccio di Papà', description: "Crema di patate al forno, prosciutto cotto azienda Cillo, provolone del Monaco, cardoncello al burro affumicato di Caseificio di Aurora, fior di latte Caseificio Aurora", price: '8.00', icons: '🌾🥛' },
];

const specialeDelMeseItem: MenuItemData[] = [
    { name: 'Tegliuccio al Baccalà (Impasto con farina di Triticale)', description: "Ristretto di pomodoro San Marzano biologico, filetti di pomodoro San Marzano arrosto, baccalà mantecato, battuto di aglio, prezzemolo e peperoncino con olio EVO.", price: '10.00', icons: '🌾🐟' },
];
