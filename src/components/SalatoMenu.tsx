...
const tegliucciItems: MenuItemData[] = [
  ...
  { name: 'Tegliuccio Chieno Spalla di Maiale Nero', description: "Spalla di maiale nero cotta a bassa temperatura, mozzarella del Caseificio Aurora, provolone dei Monti Lattari, battuto di olio EVO monocultivar Rotondella, prezzemolo, peperoncino, gocce di marmellata di albicocche Pellecchiella del Vesuvio.", price: '9.50', icons: '🐖🧀' },
